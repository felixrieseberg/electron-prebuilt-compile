// Type definitions for Electron 6.0.0-beta.1
...
declare namespace Electron {
  ...
  interface Dialog extends EventEmitter {
     ...
     */
    showMessageBox(browserWindow: BrowserWindow, options: MessageBoxOptions): Promise<any>;
    /**
     * Shows a message box, it will block the process until the message box is closed.
     * The browserWindow argument allows the dialog to attach itself to a parent
     * window, making it modal.
     */
    showMessageBox(options: MessageBoxOptions): Promise<any>;
    /**
     * Shows a message box, it will block the process until the message box is closed.
     ...
     */
    showOpenDialog(browserWindow: BrowserWindow, options: OpenDialogOptions, callback?: Function): Promise<any>;
    /**
     * The browserWindow argument allows the dialog to attach itself to a parent
     * window, making it modal. The filters specifies an array of file types that can
     * be displayed or selected when you want to limit the user to a specific type. For
     ...
     * selector will be shown.
     */
    showOpenDialog(options: OpenDialogOptions, callback?: Function): Promise<any>;
    /**
     * The browserWindow argument allows the dialog to attach itself to a parent
     * window, making it modal. The filters specifies an array of file types that can
     * be displayed or selected when you want to limit the user to a specific type. For
     ...
     * collapsing the dialog.
     */
    showSaveDialog(browserWindow: BrowserWindow, options: SaveDialogOptions): Promise<any>;
    /**
     * The browserWindow argument allows the dialog to attach itself to a parent
     * window, making it modal. The filters specifies an array of file types that can
     * be displayed, see dialog.showOpenDialog for an example.
